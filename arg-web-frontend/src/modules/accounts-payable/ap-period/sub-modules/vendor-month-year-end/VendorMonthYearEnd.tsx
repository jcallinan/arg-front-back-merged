...
const VendorMonthYearEnd: React.FC = () => {
  ...
  const { data: yearData } = useDropdownData("AP_PERIOD_END_YEARS");
  ...
  // Generate year options from dynamic dropdown data
  const yearOptions =
    yearData?.map((item) => ({
    ...
    <div>
      ...
      <div className="content-div-container">
          ...
          <div className="switch-margin">
            <p className="sub-title switch-gap">Clear Calendar Year to Date Fields</p>
            <Switch
        ...
        <div className="flex-end">
          <ActionPermissionGuard actionId="vendor-month-year-end.submit">
            <CustomStyledButton
              name="submit"
              label={<h6>Submit</h6>}
