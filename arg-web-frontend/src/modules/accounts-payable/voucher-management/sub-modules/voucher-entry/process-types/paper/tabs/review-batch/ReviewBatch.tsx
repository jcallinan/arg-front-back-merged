...
const ReviewBatch: React.FC<{ uploadStatusData?: UploadStatusData; enabledQueries?: boolean }> = ({
   uploadStatusData,
   enabledQueries = true,
}) => {
   ...
   } = usePaperEntries(10, enabledQueries);

   const {
      data: voucherSummary,
      refetch: refetchPaperVoucherSummary,
   } = usePaperVoucherSummary(10, enabledQueries);
   ...
   }, [enabledQueries, paperEntriesData]);
   ...
   }, [enabledQueries, paperEntriesError]);
   ...
   }, [enabledQueries, editVoucherData, isEditVoucherLoading, navigate]);
   ...
   }, [enabledQueries, editVoucherError]);
   ...
   useEffect(() => {
      // Data will be fetched automatically by React Query hooks when enabled
   }, [enabledQueries]);
   ...
   // invalidate the batch-entries list exactly once so it refreshes after review batch data.
   ...
   useEffect(() => {
      ...
      const entriesReady = Array.isArray(paperEntriesData);
   ...
   }, [enabledQueries, uploadStatusData?.summary, paperEntriesData, voucherSummary, queryClient]);
   ...
   const isRowSelectable = (entry: PaperEntryItem) => {
         ...
         render: (_, record) => (
            <Checkbox
               ...
               onChange={() =>
                  ...
                  handleRowSelect(String(record.key))
               }
         ...
         render: (_, record) => (
            <div className="action-icons flex-align">
               <ActionPermissionGuard
                  actionId="voucher-entry.paper.view"
                  requireManage={false}
               >
               ...
               <ActionPermissionGuard actionId="voucher-entry.paper.edit">
               ...
               <ActionPermissionGuard actionId="voucher-entry.paper.delete">
         ...
         <div className="content-card-body">
            <div className="flex-between">
               ...
               <div className="action-buttons">
                  <ActionPermissionGuard actionId="voucher-entry.paper.post">
                     <CustomStyledButton
