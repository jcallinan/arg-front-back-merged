...
import {
   useVoucherConfig,
   useSubmitVoucherHeader,
   useSubmitVoucher,
} from "@hooks/useNormalProcess";
...
const CreateNewEntry = () => {
   ...
   // Ref to prevent concurrent vendor change API calls
   const processingVendorChange = useRef(false);
            ...
            <div className="vendor-select-container">
               <VendorNumberName
                  ...
                  onChange={async (value) => {
                     // Prevent concurrent executions of onChange handler
                     if (processingVendorChange.current) {
                        return;
                     }
                     ...
                     processingVendorChange.current = true;
                     ...
                     try {
                        ...
                        // If vendor is cleared (empty value), just reset form without API call
                        if (!value || value === "") {
                           setFormData(blankHeader);
                        ...
                        if (isErrorCorrection) {
                           ...
                           const updatedFormData = {
                              ...
                              "Hold Description":
                                ...
                                carrierId: vendor?.vendorCarrierId || "",
                           };
                        ...
                        processingVendorChange.current = false;
                     }
                  }}
