...
const NormalProcess: React.FC<NormalProcessProps> = ({ selectedCompany }) => {
  ...
  const isRowSelectable = (entry: VoucherEntryUI) => {
    ...
    return !(hasPrepaidCode && !hasPrepaidCheckDate);
  };
  ...
  const columns: ColumnType<any>[] = [
    {
      ...
      dataIndex: "",
      fixed: "left",
      render: (_: any, record: VoucherEntryUI) => {
        const { key } = record;
        ...
        return (
          <Checkbox
            ...
            disabled={!selectable}
            onChange={() => selectable && handleRowSelect(key)}
      ...
      render: (_, record) => (
        <div className="action-icons flex-align">
          <ActionPermissionGuard
            actionId="voucher-entry.normal.view"
            requireManage={false}
          >
            <Tooltip
          ...
          <ActionPermissionGuard actionId="voucher-entry.normal.edit">
            <Tooltip
          ...
          <ActionPermissionGuard actionId="voucher-entry.normal.delete">
            <Tooltip
    ...
    <>
      ...
      <div className="content-card-body">
        <div className="flex-between">
          ...
          <div className="action-buttons">
            <ActionPermissionGuard actionId="voucher-entry.normal.post">
              <CustomStyledButton
      ...
      {viewRecord && (
        <ViewVoucherModal
          ...
          editActionId="voucher-entry.normal.edit"
          onEdit={() =>
            handleEditClick({
              entryNo: viewRecord.entryNo,
              companyNo: viewRecord.companyNo,
