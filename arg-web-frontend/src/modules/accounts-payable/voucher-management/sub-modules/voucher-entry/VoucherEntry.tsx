        ...
        <div className="content-card-body flex-content">
          ...
          {selectedProcessTypeApi === "NORMAL" && (
            <>
              ...
              />
              <ActionPermissionGuard actionId="voucher-entry.normal.create">
                <CustomStyledButton
                  name="createNewEntry"
          ...
          {selectedProcessTypeApi === "FLEXI" && (
            <>
              <ActionPermissionGuard actionId="voucher-entry.flexi.upload">
                <CustomStyledButton
                  name="uploadCSV"
              ...
              <ActionPermissionGuard
                actionId="voucher-entry.flexi.download-template"
                requireManage={false}
              >
                <CustomStyledButton
          ...
          {selectedProcessTypeApi === "SOGAS" && (
            <>
              ...
              <ActionPermissionGuard actionId="voucher-entry.sogas.upload">
                <CustomStyledButton
                  name="uploadCSV"
                  label={<h6>{UPLOAD_CSV_MODAL_TEXTS.TITLE}</h6>}
                  onClick={() => {
              ...
              <ActionPermissionGuard
                actionId="voucher-entry.sogas.download-template"
                requireManage={false}
              >
                <CustomStyledButton
                  name="downloadTemplate"
