...
const CheckEnquiry: React.FC = () => {
   ...
   const columns: (ColumnType<CheckPaymentHistoryUI> & {
...

      {
         ...
         key: "paidOnDate",
         ...getColumnSearchProps("paidOnDate", "Search Paid On Date"),
         sorter: createPaidDateSorter("paidOnDate"),
      ...
      <>
         ...
         <div className="content-div-container">
            <div className="filter-grids-container">
               ...
               <div className="filter-field">
                     <p className="sub-title"> Paid On Date</p>
                     <CustomDatePicker
                        name="startDate"
                        value={startDate || ""}
         ...
         <div className="content-div-container">
            <div className="content-card-body">
               <h4>Check Invoice Payment History</h4>
