...
// Lightweight stubs - partially mock antd so ConfigProvider and others still work
vi.mock('antd', async () => {
...
describe('AddVendor (lightweight)', () => {
  ...
  it('calls onCancel when Cancel clicked', async () => {
    ...
    render(<AddVendor onCancel={onCancel} /> as any);
