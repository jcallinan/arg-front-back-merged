      ...
      if (!response.ok) {
         try {
            ...
            if (
               ...
               console.log(
                  "🚨 Unauthorized error detected, logging out user..."
               );
               ...
               try {
                  await logoutUser();
                  console.log(
                     "✅ User logged out successfully due to token expiration"
                  );
               } catch (logoutError) {
                  console.error(
               ...
               // You can customize this behavior based on your app's routing
