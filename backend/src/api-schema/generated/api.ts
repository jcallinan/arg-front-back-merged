...
*/
  ...
  /**
 * @description Submit Payment Selection Type for Check, ACH, or Wire vouchers and mode save or edit Frontend usage: api.payment.submitPaymentSelectionType()
 * @tags Payment
...
*/
  ...
  /**
 * @description Adds, updates, or deletes a single vendor payment line in an active payment selection type for Check, ACH, or Wire vouchers. Frontend usage: api.payment.submitVendorPayment()
 * @tags Payment
