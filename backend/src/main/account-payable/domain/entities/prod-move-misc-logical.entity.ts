export class ProdMoveMiscLogical {
  isDeleted!: string;
  companyNo!: number;
  customerNo!: number;
  invoiceNo!: number;
  ...
  constructor(partial: Partial<ProdMoveMiscLogical>) {
    Object.assign(this, partial);
  }

  static create(partial: Partial<ProdMoveMiscLogical>): ProdMoveMiscLogical {
    return new ProdMoveMiscLogical(partial);
  }

  update(partial: Partial<ProdMoveMiscLogical>): void {
    Object.assign(this, partial);
  }
