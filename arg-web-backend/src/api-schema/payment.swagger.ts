...
export const submitPaymentSelectionType = {
  ...
  operation: {
    ...
    description:
      "Submit Payment Selection Type for Check, ACH, or Wire Employee Expense, or Utility vouchers and mode save or edit",
  ...
  body: {
    ...
    examples: {
      ...
      EmployeeExpenseVoucherExample: {
        summary: PAYMENT_VOUCHER_TYPES.EMPLOYEE_EXPENSE,
        value: {
          companyNo: 40,
          voucherToPay: PAYMENT_VOUCHER_TYPES.EMPLOYEE_EXPENSE,
          startingCheckNo: 400001,
          checkDate: "080825",
          dateToPayBy: "080925",
          bankAccountGl: 12010001,
          forcedDiscount: FORCED_DISCOUNT_VALUES.YES,
      ...
      UtilityVoucherExample: {
        summary: PAYMENT_VOUCHER_TYPES.UTILITY,
        value: {
          companyNo: 50,
          voucherToPay: PAYMENT_VOUCHER_TYPES.UTILITY,
          startingCheckNo: 500001,
          checkDate: "081025",
          dateToPayBy: "081125",
          bankAccountGl: 12010001,
          forcedDiscount: FORCED_DISCOUNT_VALUES.YES,
...
export const submitVendorPayment = {
  ...
  operation: {
    ...
    description:
      "Adds, updates, or deletes a single vendor payment line in an active payment selection type for Check, ACH, or Wire Employee Expense, or Utility vouchers.",
  ...
  body: {
    ...
    examples: {
      ...
      // -------------------- EMPLOYEE EXPENSE --------------------
      insertEmployeeExpense: {
        summary: "Insert - Pay one voucher (Employee Expense)",
        value: {
          companyNo: 10,
          voucherToPay: PAYMENT_VOUCHER_TYPES.EMPLOYEE_EXPENSE,
          bankAccountGl: 11000001,
          ...
          item: {
            ...
            vendorNo: 1875,
            voucherNo: 60001,
            partialPayAmount: 1000.0,
            discountAmount: 50.0,
            payOrHold: "P",
            singleCheck: "",
            makePrepaid: MakePrepaidFlag.EMPLOYEE_EXPENSE,
            prepaidDate: "080125",
            forcedDiscount: FORCED_DISCOUNT_VALUES.NO,
            mode: PAYMENT_OPERATION_MODE.SAVE,
          },
      ...
      updateEmployeeExpense: {
        summary: "Update existing voucher (Employee Expense)",
        value: {
          companyNo: 10,
          voucherToPay: PAYMENT_VOUCHER_TYPES.EMPLOYEE_EXPENSE,
          bankAccountGl: 11000001,
      ...
      deleteEmployeeExpense: {
        summary: "Delete voucher (Employee Expense)",
        value: {
          companyNo: 10,
          voucherToPay: PAYMENT_VOUCHER_TYPES.EMPLOYEE_EXPENSE,
          bankAccountGl: 11000001,
    ...
    // -------------------- UTILITY --------------------
    insertUtility: {
      summary: "Insert - Pay one voucher (Utility)",
      value: {
        companyNo: 10,
        voucherToPay: PAYMENT_VOUCHER_TYPES.UTILITY,
        bankAccountGl: 11000001,
        ...
        item: {
          ...
          payOrHold: "P",
          singleCheck: "",
          makePrepaid: MakePrepaidFlag.UTILITY,
          prepaidDate: "080125",
          forcedDiscount: FORCED_DISCOUNT_VALUES.NO,
          mode: PAYMENT_OPERATION_MODE.SAVE,
        },
    ...
    updateUtility: {
      summary: "Update existing voucher (Utility)",
      value: {
        companyNo: 10,
        voucherToPay: PAYMENT_VOUCHER_TYPES.UTILITY,
        bankAccountGl: 11000001,
    ...
    deleteUtility: {
      summary: "Delete voucher (Utility)",
      value: {
        companyNo: 10,
        voucherToPay: PAYMENT_VOUCHER_TYPES.UTILITY,
        bankAccountGl: 11000001,  
