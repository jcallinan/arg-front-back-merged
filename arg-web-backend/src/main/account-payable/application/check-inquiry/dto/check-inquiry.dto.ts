...
export class CheckInquiryResponseDto {
  ...
  @ApiProperty({ description: 'Paid On Date', example: '01/01/2025' })
  paidOnDate!: number | string;

  @ApiProperty({ description: 'Last Paid Date', example: '01/01/2025' })
  lastPaidDate!: number | string;
