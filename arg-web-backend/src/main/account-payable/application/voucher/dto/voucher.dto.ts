...
import { NoPositiveIfNegative } from '@src/shared/dto/allow-negative-if-decorater';
...
export class HeaderDto {
  ...
  @IsOptional()
  @IsString()
  @MaxLength(25, { message: "Invoice description must be a string at most 25 characters long" })
  invoiceDesc?: string;
  ...
  @ApiProperty({ description: "Prepaid Check Date 8", required: false })
  @IsOptional()
  @IsString()
  prepaidCheckdate8?: string;

  @ApiProperty({ description: "Total Freight", required: false })
  @IsOptional()
  @IsNumber()
  @Max(9999999.99)
  @NoPositiveIfNegative<HeaderDto>(
    'invoiceAmount',{ message: "Total Freight must be negative as Invoice Amount is negative" }
  )
  totalFreight?: number;
...
export class DetailDto {
  ...
  @IsOptional()
  @IsString()
  @MaxLength(25, { message: "Line description must be a string at most 25 characters long" })
  lineDesc?: string;
  ...
  @IsOptional()
  @IsNumber()
  @NoPositiveIfNegative<DetailDto>(
    'lineAmount',{ message: "Discount Amount must be negative as Line Amount is negative" }
  )
  @Max(999999999.99)
  ...
  @IsNumber()
  @NoPositiveIfNegative<DetailDto>(
    'lineAmount',{ message: "Freight Amount must be negative as Line Amount is negative" }
  )
  @Max(9999999.99)
