...
export class UpdateCompanyMaintenanceDto {
  ...
  @IsString()
  @MinLength(1)
  @MaxLength(30, { message: "COMPANY NAME MUST BE LESS THAN 30 CHARACTERS" })
  companyName!: string;
  ...
  @ApiProperty({
    description: "Company Interco GL Number (optional, validated if != 0)",
    example: 30000001,
    required: true,
  })
  @IsDefined()
  ...
  @ApiProperty({
    description: "Company Next Entry Number (NXTE). If ≤ 0, will be forced to 1.",
    example: 10001,
    required: true,
  })
  @IsDefined()
  ...
  @ApiProperty({
    description: "Company Next Voucher Number (NXVO). If ≤ 0, will be forced to 1.",
    example: 10001,
    required: true,
  })
  @IsDefined()
  ...
  @ApiProperty({
    description: "Company Retention GL Number (optional, validated if != 0)",
    example: 40000001,
    required: true,
  })
  @IsDefined()
  ...
  @ApiProperty({
    description: "Company Employee Expense GL Number (optional, validated if != 0)",
    example: 60000001,
    required: true,
  })
  @IsDefined()
