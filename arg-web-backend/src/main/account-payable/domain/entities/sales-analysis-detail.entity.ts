export class SalesAnalysisDetail{
  isDeleted!: string;
  companyNo!: number;
  customerNo!: number;
  invoiceNo!: number;
  ...
  constructor(partial: Partial<SalesAnalysisDetail>) {
    Object.assign(this, partial);
  }

  static create(partial: Partial<SalesAnalysisDetail>): SalesAnalysisDetail {
    return new SalesAnalysisDetail(partial);
  }

  update(partial: Partial<SalesAnalysisDetail>): void {
    Object.assign(this, partial);
  }
